       ...
       const iconStyles= {
        ...
        return (
           ...
           {/* <Header */}
            ...
            <MDBIcon icon="map-marker-alt"> Location: <a href=" http://maps.google.com/?q=Bengaluru,IN"  class="text-primary">Bengaluru,IN</a></MDBIcon> 
...
<div className="text-center font-bold">
  ...
  <div class="d-flex justify-content-between">
    <FormGroup>
    <FormLabel column >Enter Keywords</FormLabel>
   
   
    <FormControl type="text" placeholder="Ex:Python, Java" />
 ...
 <FormGroup>
  ...
  <div className="text-center font-bold">
      <h3>Search for Training Programs from Qualified Instructors</h3>
   </div><br />
   <FormGroup as={Row} >
   <div class="d-flex justify-content-between">
      <FormGroup>
...
<FormGroup>
  ...
  <div className="text-center font-bold">
      <h3>Search for eager to join JobSeekers</h3>
   </div>
   <br />
   <FormGroup as={Row} >
   <div class="d-flex justify-content-between">
...
<FormGroup>
  ...
  <div className="text-center font-bold">
      <h3>Trending Training Programs in Bangalore</h3>
   </div>
  <div class="container">
  ...
  <div class="carousel-inner center">
    <div class="carousel-item active ">
      <img class="d-block w-100 h-50" src={"/image/training.jpg"} alt="First slide"/>
    </div>
    <div class="carousel-item ">
      <img class="d-block w-100 h-50" src={"/image/training2.jpg"} alt="Second slide"/>
    </div>
