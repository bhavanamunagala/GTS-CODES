...
public class PermissionDto {
	...
	public String toString() {
		return "PermissionDto [gts_permission_id=" + gts_permission_id + ", gts_permission_name=" + gts_permission_name
				+ ", gts_permission_status=" + gts_permission_status + ", gts_permission_description="
				+ gts_permission_description + "]";
	}
