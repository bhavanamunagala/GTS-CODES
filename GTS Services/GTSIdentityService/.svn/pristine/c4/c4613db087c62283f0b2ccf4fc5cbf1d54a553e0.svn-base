...
public class RoleEntity implements Serializable{
	...
	public String toString() {
		return "RoleEntity [gts_role_id=" + gts_role_id + ", gts_role_name=" + gts_role_name + ", gts_role_status="
				+ gts_role_status + ", gts_role_description=" + gts_role_description + ", users=" + users
