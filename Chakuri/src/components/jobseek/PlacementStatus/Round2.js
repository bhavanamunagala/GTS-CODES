...
class Round2 extends Component {
    ...
    componentDidMount(){
        ...
        .then((result) => {
            ...
            let filteredJob=this.state.totalJobs.filter(fj=>fj.gts_job_application_status=="Round 2");
    ...
    render() {
        ...
        return (this.state.round.map(appliedJob=>(
             <div><div className="card" style={{ width: "79rem" }} data-toggle="modal" data-target="#recommendedjobmodal5">
            ...
            <div class="modal fade" id="recommendedjobmodal5" tabindex="-1" ariaLabelledby="exampleModalLabel" ariaHidden="true">
