...
class Jobs extends Component {
    ...
    componentDidMount(){
        ...
        .then((result) => {
            ...
            let filteredJob=this.state.totalJobs.filter(fj=>fj.gts_job_application_status=="shortlisted");
            this.setState({resumeShortlisted:filteredJob})
            console.log("Shortlisted jobs are ",this.state.resumeShortlisted);
        }).catch((err) => {
    ...
    render() {
        const {error,resumeShortlisted}=this.state;
        console.log("in jobs",resumeShortlisted);
 

        return (this.state.resumeShortlisted.map(appliedJob=>(
