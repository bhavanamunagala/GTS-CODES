...
class CompletedTraining extends Component {
    constructor() {
        super();
        this.state = {
            training:[],
    ...
    render() {
        ...
        return (this.state.Completed.map(cj=>(

        <div><div className="card" style={{ width: "79rem" }} data-toggle="modal" data-target="#recommendedjobmodal2">
            ...
            <div class="modal fade" id="recommendedjobmodal2" tabindex="-1" ariaLabelledby="exampleModalLabel" ariaHidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content" style={{width:"60em"}}>
                        ...
                        <div class="modal-body">
                            ...
                            <br />
                            <h6>Duration <span className="jobTile"><b>{cj.training_id.gts_training_duration}</b></span>: <span className="jobTile"><b></b></span></h6>
