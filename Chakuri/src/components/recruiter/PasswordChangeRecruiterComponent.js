...
import axios from 'axios';
 import  './PasswordChangeRecruiterComponent.css';
import {Card, CardBody,CardText, FormControl, FormLabel,FormCheck } from 'react-bootstrap';
import { error, event } from 'jquery';

class PasswordChangeRecruiterComponent extends React.Component {
  constructor(props){
    super(props);
    this.state={
      OPass: '',
  ...
  submitHandler= (event) => {
    ...
    <div class ="boxmodel"> 
		<p>After hitting the reset button you will be logged out and how to login again with new password.<br/>
		A confirmaton email will be sent to inform that you have changed your password.</p>
	</div>
...
export default PasswordChangeRecruiterComponent;
