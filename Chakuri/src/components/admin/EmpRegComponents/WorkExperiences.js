...
deleteWorkExperience(workexperienceid){
    {
        ...
        axios.delete('http://localhost:4736/api/v1/user/work_experience/work_experience_id?workExperienceId='+workexperienceid).then(response=>{
    ...
    addWorkExperience=e=>{
        ...
        axios.post('http://localhost:4736/api/v1/user/work_experience',this.state.work_experince).then(response=>{
    ...
    editWorkExperience(workexperienceid){
        ...
        console.log("state is"+JSON.stringify(this.state.work_experince))
        axios.put('http://localhost:4736/api/v1/user/work_experience',this.state.work_experince).then(response=>{
            console.log("response is "+JSON.stringify(response))
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:4736/api/v1/user/work_experience/user_id?userId=1')
            .then(res => {
        ...
        axios.get('http://localhost:4736/api/v1/user/work_experience/totalDurationOfWorkExperience/user_id?userId=1').then(res => {
                    ...
                    <div className="container">
                        <div className='mt-3 '><div className="border border-dark rounded-lg " >
                           ...
                           <label><h5><FontAwesomeIcon icon={faUpload}/></h5></label>
                                ...
                                <div class="col-7 ">
                                    <label class="text-dark">Total Duration of work Experience: &nbsp;&nbsp;{this.state.totalDuration}</label>
                            ...
                            <button type="button" class="btn btn-primary float-right" data-toggle="collapse" data-target="#a" aria-expanded="false" aria-controls="#a">-</button>
                            {this.state.workexperinces.map((workexperince) => {
                                return (
                                    ...
                                    <div >
                                        <div className="container" key={workexperince.GTS_USER_WORK_EXPERIENCE_ID}>
                                            ...
                                            <div class="row-sm m-0  text-left  ">
                                                <label class="text-dark">Name of the Company:&nbsp;&nbsp;{workexperince.GTS_USER_EMPLOYER} </label>
                                            ...
                                            <div class="row-sm">
                                               {!(workexperince.Till_Date) ?<label class="text-dark">End Date:&nbsp;&nbsp;{workexperince.GTS_USER_WORK_END_MONTH_YEAR}</label>:<label class="text-dark">End Date:&nbsp;&nbsp;Present</label>}
                                                {/* <input type ="text" class="text-primary" placeholder = "year" ></input> */}
                                            </div>
                                        ...
                                        <div id= {"editworkexperince"+workexperince.GTS_USER_WORK_EXPERIENCE_ID} class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <input type="checkbox" id="EditTillDate" ></input>
                                                </label>
                                                </div>
                                                                <div class="row-sm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div className="container" >
                                                ...
                                                <div class="row-sm">
                                                <label class="text-dark">Till date: &nbsp;&nbsp;
                                                <input type="checkbox" id="AddtillDate" ></input>
                                                </label>
                                                </div>
                                                <div class="row-sm">
                                                    <label class="text-dark">Job Description: &nbsp;&nbsp;
                                        ...
                                        <div class="modal-footer">
                                            <div class="text-inline">
                                           { ((!this.state.startDate)||(!this.state.endDate)||(this.state.nameOfTheCompany.length<=0)||(this.state.position.length<=0)||(this.state.jobDescription.length<=0)||(!this.state.isValidDates))? <Button id ="test" type="button">Save</Button>:<Button id ="test" type="button" data-dismiss="modal" onClick={this.addWorkExperience}>Save</Button>
                                              } 
                                               <Button type="button" class="close" data-dismiss="modal">Cancel</Button>
                                            </div>
                                        </div>
