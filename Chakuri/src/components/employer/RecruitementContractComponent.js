...
class RecruitementContractComponent extends React.Component{
     constructor(props) {
          super(props)
          this.state = {
            gts_job_position: '',
...
<form onSubmit={this.submitHandler}>
 ...
 style={{float:"right",width:"150px",display:"inline-block"}} >Add Job Position</button>
  ...
  <table class="table table-bordered table-responsive" style={{borderCollapse:"collapse",borderColor:"#f2f2f2"}}>
...
<input type="date"/>&emsp;for no. of
<input type="text"style={{width:"50px",font:"italic"}}/>  &emsp;
months.
<br></br>
...
<label>Date:</label>
<input type="Date" style={{width:"200px"}} /><br></br><br></br>
...
export default RecruitementContractComponent;