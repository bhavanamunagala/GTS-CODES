...
class LanguagePreferredComponent extends Component {
    constructor(props){
      super(props);
      this.state={
        error: null,
      ...
      const errorMessageStyles = {
       ...
       console.log(items);
         ...
         return (
            ...
            <h5 class="mb-3 p-2">Langauage Preferred</h5>
            <div className="container">
            <div class="row">
                  <div class="col">
                    <label><h5>Langauage Preferred </h5></label>
                    </div>
                  <div class="col">
...
const successMessageStyles = {
  ...
  //padding: paddings
   marginLeft: '-25%'};
 export default LanguagePreferredComponent;