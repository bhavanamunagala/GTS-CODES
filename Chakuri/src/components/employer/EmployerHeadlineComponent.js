...
class EmployerHeadLineComponent extends Component{
    constructor(props) {
        super(props);
    ...
    <input type="text" class="text-primary" class="form-control"  name="employerHeadline"  defaultValue={this.state.GtsPersonalDetailResponseModel.gts_enter_attractive_headLine} placeholder="Describe about company in Two Lines" onChange={this.changeHandler}></input>
    <div class="col-0 ">
...
export default EmployerHeadLineComponent;