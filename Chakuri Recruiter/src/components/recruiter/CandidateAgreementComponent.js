...
function Retrive (props){
    ...
    const loadUsers = async() => {
        const result = await Axios.get('http://localhost:1202/employer_agreement');
        setDetails(result.data);
    };
    const deleteDetails = async id => {
        await Axios.delete(`http://localhost:1202/employer_agreement/${id}`);
...
function CandidateAgreementComponent(){
    ...
    const onSubmit = async e =>{
        e.preventDefault();
        await Axios.post("http://localhost:1202/employer_agreement",details);
    ...
    return(
        ...
        <Container fluid>
            ...
            <br></br>
          <ul>
       <li><h5><label class="text-primary">CANDIDATE AGREEMENT</label>| CANDIDATE AGREEMENT HISTORY </h5>
       </li>
       </ul>
            ...
            <div className="mt-3">
            <div className="row">
           <div className="col-4" style={{ paddingLeft :"420px"}}><img src={process.env.PUBLIC_URL + "/image/goraitech.jpg"} 
alt="pic" width="70px" class="iconStyles"   />
</div>
    <div className="col-4">
<h3 className="text-center display-2 font-weight-bold underline" >
CHAKURI</h3>
<h3 class="text-center">CANDIDATE AGREEMENT</h3></div>
      </div>
                        ...
                        <Form onSubmit={e => onSubmit(e)}>
                            ...
                            <ButtonGroup>
                                ...
                                <Button variant="primary" type="submit"
                                 ...
                                 onClick={toggleShowA}>Save Details</Button>{" "}
                           ...
                           <Toast show={showA} onClose={toggleShowA}>
                            ...
                            <Retrive show={modalShow} onHide={() => setModalShow(true)}/>
                        </Form>
                    </Col>
                </Row>
            </div>
...
export default CandidateAgreementComponent;