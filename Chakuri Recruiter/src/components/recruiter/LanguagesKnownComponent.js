...
class LanguagesKnownComponent extends Component {
    constructor(props){
      super(props);
      this.state={
        error: null,
    ...
    var payload =/* [{
               "gtsEmployerLanguageName" : this.state.language,
               "gtsEmployerLanguageCanRead" : this.state.read,
               "gtsEmployerLanguageCanWrite" : this.state.write,
               "gtsEmployerLanguageCanSpeak" : this.state.speak,
      ...
      const errorMessageStyles = {
       ...
       console.log(items);
         ...
         return (
            ...
            <h5 class="mb-3 p-2">Langauage Known</h5>
