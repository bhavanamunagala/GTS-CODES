                                    ...
                                    <Container>
                                        ...
                                        <ButtonGroup style={{"float":"right"}}>
                                            <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={editTooltip}>
                                                <Link to={`/RecruiterProfile/UpdateProject/${pro.gts_user_project_id}`} className="btn btn-outline-success"><FaEdit/></Link>
                                            </OverlayTrigger>
...
export default GTSProjectRetrive;