...
import GTSProjectRetrive from './GTSProjectRetrive';
import GTSProjectCreate from './GTSProjectCreate';
import { FaEye } from 'react-icons/fa';

function CreateRetrive() {
